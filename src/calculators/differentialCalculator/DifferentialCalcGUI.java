...
public class DifferentialCalcGUI extends JLabel{
	...
	JLabel[] jLVariable;
	JTextField jxTextField;
	//Constructor
	
	public DifferentialCalcGUI() {
	...
	private void initialize() {
		...
		// x text field
		jxTextField.setSize(50, 30);
		jxTextField.setHorizontalAlignment(4);
		jxTextField.setFont(new Font("Tahoma", 0, 12));
		jxTextField.setBackground(new Color(220, 220, 220));
		jxTextField.setBorder(new SoftBevelBorder(BevelBorder.LOWERED));
		jxTextField.setLocation(12,93);
		...
		dbydx.setText("d/dx (");
		dbydx.setSize(60, 20);
		dbydx.setLocation(12 , 30);
		dbydx.setFont(new Font("Calibri", 0, 15));
		dbydx.setBackground(new Color(200, 200, 190));
		
		// at x Label
		atx.setText("at x");
		atx.setSize(60, 20);
		atx.setLocation(18 , 70);
		atx.setFont(new Font("Calibri", 0, 15));
		atx.setBackground(new Color(200, 200, 190));
		...
		jLabelDisplay.setLocation(70, 63);
