...
public class IntegralCalcGUI extends JLabel{
	...
	JLabel[] jLVariable;
	JTextField[] jLimitTextField;
	//Constructor
	
	public IntegralCalcGUI() {
		initialize();
	}
	...
	private void initialize() {
		...
		jLimitTextField=new JTextField[2];
																		
		// Setting Bounds and Attributes of the Elements 
		
		// limits text field
		for(int i=0; i<2; i++) {
			jLimitTextField[i]=new JTextField();
			jLimitTextField[i].setSize(50, 20);
			jLimitTextField[i].setHorizontalAlignment(4);
			jLimitTextField[i].setFont(new Font("Tahoma", 0, 12));
			jLimitTextField[i].setBackground(new Color(220, 220, 220));
			jLimitTextField[i].setBorder(new SoftBevelBorder(BevelBorder.LOWERED));
			jLimitTextField[i].setLocation(12,73);
		}
		jLimitTextField[0].setLocation(12,18);
		...
		// d/dx label
		integrate.setText("∫");
		integrate.setSize(20, 50);
		integrate.setLocation(32 , 30);
		integrate.setFont(new Font("Calibri", 0, 30));
		//jLabel.setBorder(new SoftBevelBorder(BevelBorder.LOWERED));
		integrate.setBackground(new Color(200, 200, 190));
		
		// at x Label
		dx.setText("dx");
		dx.setSize(60, 20);
		dx.setLocation(443 , 50);
		dx.setFont(new Font("Calibri", 0, 15));
		//dx.setBorder(new SoftBevelBorder(BevelBorder.LOWERED));
		dx.setBackground(new Color(200, 200, 190));
		...
		jBFunction[19].setFont(new Font("Calibri",0,14));
			...
			jBFunction[19].setLocation(324, 200); jBFunction[19].setText("x");
			jBFunction[20].setLocation(378, 200); jBFunction[20].setText("10^");
		...
		jTextDisplay.setLocation(70, 18);
		//jTextDisplay.setEditable(false);
		
		//Display label
		jLabelDisplay.setSize(390, 40);
